...
%>--%>
    <h1>
        <b>
            <center>Edición de academias </center>
        </b>
    </h1>
    <form action="AcademiaController" method="POST" name="academia">
        ...
        <div class="clearfix"></div>
        <div class="form-group">
            <label class="col-sm-2 control-label" for="Personal_idPersonal" >Lista de coordinadores
                <span class="required">*</span>
            </label>
            <div class="col-sm-10">
            ...
            <h5>
                <p align="right">
                    <font color="red">Los campos que están marcados con * son obligatorios para la edición  </font>  
                </p> 
            </h5>
        </div>  
        <div class="col-md-12 ">
