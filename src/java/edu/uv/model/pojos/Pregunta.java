...
public class Pregunta  implements java.io.Serializable {
    ...
    public Pregunta(Temas temas, String tipoPregunta, String descripcionPregunta, String modalidadPregunta, int complejidadPregunta, Integer puntuacionPregunta, String comentRetroalimentacion, Set examenPreguntas, Set respuestases) {
       this.temas = temas;
       this.tipoPregunta = tipoPregunta;
       this.descripcionPregunta = descripcionPregunta;
       this.modalidadPregunta = modalidadPregunta;
